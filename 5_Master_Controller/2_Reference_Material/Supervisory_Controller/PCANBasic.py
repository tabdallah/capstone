...
PCAN_CHANNEL_ILLEGAL     = int(0x00)  # The PCAN-Channel handle is illegal
PCAN_CHANNEL_AVAILABLE   = int(0x01)  # The PCAN-Channel handle is valid to connect/initialize
PCAN_CHANNEL_OCCUPIED    = int(0x02)  # The PCAN-Channel handle is valid, but is already being used
PCAN_CHANNEL_UNOCCUPIED  = int(0x03)  # The PCAN-Channel handle is valid and ready for use (Plug & Play hardware only)
...
class PCANBasic:
    ...
    def __init__(self):
        ...
        if self.__m_dllBasic == None:
            print "Exception: The PCAN-Basic shared library couldn't be loaded!"
